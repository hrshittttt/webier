    ...
    <section id="contact" className="relative px-6 py-20 bg-black">
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12">
          ...
          {/* Contact Information */}
          <FadeSlide direction="right" delay={0.7} duration={0.8}>
            <div className="space-y-8">
              <ScaleReveal delay={0.2} duration={0.6}>
                <SpotlightCard
                  className="contact-info rounded-xl bg-gradient-to-br from-slate-900 to-slate-800 p-6 transition duration-300 ease-in-out hover:scale-[1.02] hover:rotate-1"
              ...
              <ScaleReveal delay={0.4} duration={0.6}>
                <SpotlightCard
                  className="contact-info rounded-xl bg-gradient-to-br from-slate-900 to-slate-800 p-6 transition duration-300 ease-in-out hover:scale-[1.02] hover:-rotate-1"
              ...
              <ScaleReveal delay={0.6} duration={0.6}>
                <SpotlightCard
                  className="contact-info rounded-xl bg-gradient-to-br from-slate-900 to-slate-800 p-6 transition duration-300 ease-in-out hover:scale-[1.02] hover:rotate-1"
              ...
              {/* Response Time */}
              <ScaleReveal delay={0.8} duration={0.6}>
