  ...
  return (
      ...
      <div className="mt-16 md:mt-24 grid grid-cols-1 gap-6 md:gap-10 text-white sm:grid-cols-2 max-w-6xl mx-auto">
        ...
        <div className="space-y-4">
          {/* Project 1 */}
          <SpotlightCard
            className="custom-spotlight-card flex h-96 w-full items-center justify-center rounded-xl !bg-blue-400 transition duration-300 ease-in-out hover:scale-[1.02]"
          ...
          <div>
            ...
            <a
              ...
              className="mt-1 inline-flex items-center gap-2 text-sm text-[#d4d4d4] hover:underline"
            >
        ...
        <div className="space-y-4">
          <SpotlightCard
            className="custom-spotlight-card flex h-64 w-full items-center justify-center rounded-xl bg-pink-400 transition duration-300 ease-in-out hover:scale-[1.02]"
            spotlightColor="transparent"
          >
        ...
        <div className="space-y-4">
          <SpotlightCard
            className="custom-spotlight-card flex h-60 w-full items-center justify-center rounded-xl !bg-green-500 transition duration-300 ease-in-out hover:scale-[1.02]"
            spotlightColor="transparent"
          >
        ...
        <div className="space-y-4">
          <SpotlightCard
            className="custom-spotlight-card flex h-76 w-full items-center justify-center rounded-xl bg-purple-400 transition duration-300 ease-in-out hover:scale-[1.02]"
            spotlightColor="transparent"
          >
